...
class Curve:
    ...
    def get_discount_factor(self, tenor: list[float]) -> list[float]:
    ...
    def get_forward_rate(self, start_tenor: float, end_tenor: float, compounding_convention: CompoundingConvention) -> float:
