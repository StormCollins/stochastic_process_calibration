...
# fx_forward_price: float = fx_forward_constant_vol(notional, initial_spot, strike, domestic_interest_rate, foreign_interest_rate, time_to_maturity)
# print(f'Analytical FX Forward Price: '
#       f'{fx_forward_constant_vol(notional, initial_spot, strike, domestic_interest_rate, foreign_interest_rate, time_to_maturity)}')
...
# #       f'{fx_forward_constant_vol(initial_spot, strike, domestic_interest_rate, foreign_interest_rate, time_to_maturity)}')
